...
const debito = deepLesson({
  ...
  apply: "Entenda a frequência cardíaca como **uma das formas de aumentar o débito**; com o treino, o coração ejeta mais por batimento e precisa **bater menos para o mesmo trabalho**.\n\n**Responder à abertura:** a frequência de repouso cai porque o treino aeróbio **aumenta o volume sistólico**, e o coração entrega o mesmo sangue com menos batimentos.",
  special: [
...
const pressao = deepLesson({
  ...
  apply: "Oriente **respiração contínua** e intensidade adequada, evitando a **apneia em cargas altas**, sobretudo em hipertensos. Após o esforço, a pressão tende a cair; monitore quando indicado.\n\n**Responder à abertura:** prender a respiração (Valsalva) eleva a pressão de forma aguda; num hipertenso, isso soma-se a uma pressão de base já alta, **aumentando o risco**.",
  special: [
    "Hipertensão: predominância **aeróbia moderada**; **evitar apneia** e cargas máximas; monitorar de perto.",
...
const ventilacao = deepLesson({
  ...
  apply: "Use a respiração e a fala como **guia de intensidade**: fala confortável indica esforço leve a moderado; **dificuldade para falar** indica intensidade maior.\n\n**Responder à abertura:** quando o aluno deixa de conseguir falar frases confortavelmente e passa a palavras soltas, **cruzou para uma intensidade mais exigente**.",
  special: [
...
const consumo = deepLesson({
  ...
  apply: "Entenda o VO2 como a **demanda da tarefa**: aumentar a intensidade ou o volume eleva o consumo de oxigênio e o estímulo aeróbio. **Progrida de forma gradual**, e espere que, com o treino, o mesmo esforço fique mais fácil.\n\n**Responder à abertura:** caminhar rápido exige mais energia, logo mais oxigênio; a progressão consiste em **aumentar gradualmente a demanda** que o aluno tolera.",
  special: [
...
const agudaCronica = deepLesson({
  ...
  hero: "O cansaço de hoje **não é o resultado de amanhã**. A **resposta aguda** é o que o corpo faz durante e logo após a sessão; a **adaptação crônica** é a mudança que se consolida ao longo de semanas.\n\nConfundi-las gera **decisões erradas**.",
...
const homeostase = deepLesson({
  ...
  hero: "O corpo tende a **manter o equilíbrio**. Um **estímulo** que o desafia, seguido de **recuperação**, faz o organismo se reconstruir um pouco mais capaz.\n\nEsse é o princípio que sustenta **toda progressão**.",
  ...
  apply: "Aplique o princípio: para continuar adaptando, o estímulo precisa **desafiar a homeostase** e haver **recuperação**. Por isso a **progressão gradual** e o descanso são essenciais.\n\n**Responder à abertura:** um treino que nunca muda deixa de desafiar a homeostase; sem novo estímulo, o corpo não tem motivo para se adaptar mais.",
  special: [
...
const transporteMembrana = deepLesson({
  ...
  apply: "Use esses princípios para explicar **hidratação, edema e reposição de eletrólitos** sem simplificações: diferencie **concentração, osmolaridade, tonicidade e volume** dos compartimentos.\n\n**Responder à abertura:** a bomba gasta energia continuamente porque os **íons vazam de volta pelos canais**; sem ela, os gradientes se dissipariam e a célula perderia volume e excitabilidade.",
  special: [
...
const bioeletricidade = deepLesson({
  ...
  apply: "Use o conceito para interpretar **comando motor e fadiga** sem antecipar toda a fisiologia do exercício: a força é graduada por **quantos neurônios disparam e com que frequência**, não por potenciais 'maiores'.\n\n**Responder à abertura:** o potencial de ação é **tudo-ou-nada**; um estímulo mais forte, acima do limiar, **aumenta a frequência de disparos**, não a amplitude de cada um.",
  special: [
...
const endocrino = deepLesson({
  ...
  apply: "Interprete o sistema endócrino como **rede**: insulina e glucagon regulam substratos, catecolaminas e cortisol organizam a resposta ao estresse, ADH e aldosterona ajustam água e sódio.\n\n**Responder à abertura:** rótulos como 'anabólico' e 'catabólico' são incompletos porque o efeito depende de **dose, tempo, tecido, receptor e disponibilidade de substrato**, além da interação com outros sinais.",
  special: [
...
const cicloCardiaco = deepLesson({
  ...
  hero: "O coração enche e ejeta de forma coordenada. Durante a **diástole** os ventrículos relaxam e enchem; na **sístole** elevam a pressão e ejetam.\n\nAs válvulas apenas **seguem os gradientes de pressão**.",
  ...
  apply: "Use as curvas de pressão para entender por que a pressão aórtica se mantém alta na diástole (**reservatório elástico**) e por que o enchimento depende do **retorno venoso**.\n\n**Responder à abertura:** a válvula abre quando a pressão a montante supera a a jusante e fecha quando o gradiente se inverte; **é a pressão que comanda**, não a válvula.",
  special: [
...
const transporteGases = deepLesson({
  ...
  apply: "Use o efeito Bohr para explicar por que o exercício **melhora a entrega de oxigênio** ao músculo ativo: o próprio metabolismo local cria as condições que liberam O₂.\n\n**Responder à abertura:** o músculo ativo produz mais CO₂, H⁺ e calor, que **deslocam a curva à direita** e liberam mais oxigênio na mesma pressão parcial.",
  special: [
...
const musculo = deepLesson({
  ...
  hero: "A força **não vem só do tamanho do músculo**. Ela nasce no **sarcômero**: o cálcio libera a actina, a miosina puxa o filamento e o ATP permite recomeçar o ciclo.\n\nArquitetura, comprimento e ativação também decidem a **força externa**.",
  ...
  apply: "Explique a **força além do tamanho**: arquitetura muscular, comprimento (relação comprimento-tensão), velocidade (relação força-velocidade), ativação neural, alavancas e propriedades do tendão.\n\n**Responder à abertura:** dois músculos de tamanho parecido podem diferir em **arquitetura, ativação neural, comprimento operacional e alavancas**, produzindo forças externas diferentes.",
  special: [
...
const relacaoForca = deepLesson({
  ...
  apply: "Use a relação comprimento-tensão para entender **pontos de menor força** (sticking points) e a escolha de amplitude, sem transformar isso em **regra rígida**.\n\n**Responder à abertura:** o exercício parece mais difícil onde a sobreposição dos filamentos e as alavancas produzem **menor força ativa** naquele ângulo.",
  special: [
...
const viasEnergeticas = deepLesson({
  ...
  hero: "Toda contração **gasta ATP**. Glicólise, beta-oxidação, ciclo de Krebs e fosforilação oxidativa **convergem** para repor essa energia.\n\nEntender isso derruba o mito de que 'aeróbio' e 'anaeróbio' são **exercícios opostos**.",
  ...
  apply: "Use as vias para orientar a progressão **sem rótulos rígidos**: a contribuição relativa muda com **intensidade, disponibilidade de substrato, oxigênio, duração e estado de treino**.\n\n**Responder à abertura:** as vias operam **simultaneamente**; o que muda é a contribuição relativa. Um exercício nunca é 'puramente' aeróbio ou anaeróbio.",
  special: [
...
const renal = deepLesson({
  ...
  concepts: [
    ...
    { term: "Controle de volume e pressão", definition: "O **ADH** ajusta a reabsorção de água conforme a osmolaridade; o sistema **renina-angiotensina-aldosterona** ajusta sódio e volume conforme a perfusão. A autorregulação protege o néfron." },
  ],
  figure: { id: "nefron" },
  apply: "Use o néfron para entender **hidratação e pressão**: a perda de água pelo suor altera os sinais que modulam **ADH, sede, tônus vascular e reabsorção**.\n\n**Responder à abertura:** a maior parte do filtrado é **reabsorvida ao longo do túbulo**; só uma fração pequena vira urina, ajustada às necessidades do corpo.",
  special: [
...
const integracao = deepLesson({
  ...
  hero: "Nenhum sistema trabalha sozinho no movimento. Comando motor, energia, circulação, ventilação e termorregulação se ajustam juntos, **em tempos diferentes**.\n\nPor isso **nenhuma medida isolada resume a carga fisiológica**.",
  ...
  apply: "Construa explicações causais que **integram sistemas**, sem reduzir tudo a um deles: leia a frequência cardíaca como **resposta**, junto de percepção de esforço, ventilação e contexto.\n\n**Responder à abertura:** a frequência é uma variável de resposta influenciada por **calor, hidratação, sono, cafeína e emoção**; sozinha, não resume a carga.",
  special: [
  ...
  mechanism: {
    ...
    steps: [
      ...
      },
      {
        ...
        figureId: "equilibrio-autonomico",
        detail:
...
const capSistemaMuscular = deepLesson({
  ...
  apply: "Manipule **amplitude, intensidade, proximidade da falha e recuperação**, não apenas 'sentir dor'. A escolha do exercício e da amplitude muda a **região de maior tensão**.\n\n**Responder à abertura:** o exercício com pico na posição alongada combina **maior força passiva, braço de momento e comprimento de fibra** diferentes, mudando a exigência mesmo com carga igual.",
  specialTitle: "Medida e interpretação: o que cada variável informa e onde ela cala",
  special: [
  ...
  refs: [...REF_BASE, "ref-lieber-musculo-2010", "ref-schoenfeld-hipertrofia-2010", "ref-zatsiorsky-biomecanica-2012", "ref-costanzo-2026"],
...
const capSistemaCardiovascular = deepLesson({
  ...
  apply: "Leia a FC como uma **variável de resposta**, junto de percepção de esforço, ventilação e contexto. No treino de força com hipertensos, oriente **respiração contínua** e intensidade moderada, evitando apneia.\n\n**Responder à abertura:** no calor, a **deriva cardiovascular** eleva a FC para a mesma tarefa; isso **não indica piora do condicionamento**.",
  specialTitle: "Medida e interpretação: o que cada variável informa e onde ela cala",
  special: [
...
const capSistemaRespiratorio = deepLesson({
  ...
  apply: "Use a respiração e a fala como **guia de intensidade** sem equipamento: fala confortável indica esforço leve a moderado; falar só **palavras soltas** indica proximidade de um limiar mais alto.\n\n**Responder à abertura:** quando o aluno deixa de conseguir falar frases confortavelmente, **cruzou para uma intensidade mais exigente**.",
  specialTitle: "Medida e interpretação: o que cada variável informa e onde ela cala",
  special: [
...
const capSistemaHematologico = deepLesson({
  ...
  apply: "**Padronize horário, postura, hidratação e intervalo** após o exercício antes de comparar exames. Integre sintomas e marcadores de ferro em vez de reagir a um **valor isolado**.\n\n**Responder à abertura:** o hematócrito subiu por **hemoconcentração** (perda de água pelo suor); não houve produção imediata de mais sangue.",
  specialTitle: "Medida e interpretação: o que cada variável informa e onde ela cala",
  special: [
...
const capSistemaRenal = deepLesson({
  ...
  apply: "Ligue o rim à **hidratação e à pressão**: planos de hidratação devem partir de **experiência, sede, taxa de suor e duração**, evitando tanto o déficit excessivo quanto o ganho de massa por excesso de água.\n\n**Responder à abertura:** beber água em excesso pode diluir o sódio (**hiponatremia**), sobretudo com ADH alto; cefaleia e confusão são sinais que **exigem interrupção e atendimento**.",
  specialTitle: "Medida e interpretação: o que cada variável informa e onde ela cala",
  special: [
...
const capSistemaEndocrino = deepLesson({
  ...
  apply: "Interprete hormônios com **horário, sono, alimentação, estresse e carga de treino**, nunca por um **valor isolado**. Use o exercício como potente **modulador da sensibilidade à insulina**.\n\n**Responder à abertura:** um cortisol elevado com pouco sono e déficit energético tem várias explicações (ritmo circadiano, restrição, carga); um único resultado **não define 'falha adrenal' nem overtraining**.",
  specialTitle: "Medida e interpretação: o que cada variável informa e onde ela cala",
  special: [
...
const capSistemaDigestorio = deepLesson({
  ...
  apply: "Ajuste a estratégia nutricional ao **objetivo, ao horário e à tolerância**; **treine a ingestão** em provas longas em vez de improvisar no dia.\n\n**Responder à abertura:** um gel muito concentrado com pouca água **eleva a osmolaridade luminal**, atrasa o esvaziamento e supera a capacidade de transporte, gerando os sintomas; **diluir e treinar a estratégia** ajuda.",
  specialTitle: "Medida e interpretação: o que cada variável informa e onde ela cala",
  special: [
...
const capSistemaEsqueletico = deepLesson({
  ...
  figure: { id: "tempos-adaptacao-tecido", caption: "O músculo ganha força em semanas, mas o tendão e o osso adaptam em meses e a cartilagem é ainda mais lenta; subir carga no ritmo da força sobrecarrega o tecido conjuntivo mais lento, o que costuma aparecer como dor no tendão." },
  ...
  apply: "Progrida a carga considerando o **tecido mais lento**, não só a força muscular: combine **amplitude, velocidade, volume e tolerância**, com progressão gradual.\n\n**Responder à abertura:** a força muscular subiu mais rápido que a **tolerância do tendão**; a dor sinaliza que a assinatura mecânica (volume e velocidade) **avançou além da capacidade atual do tendão**, que adapta mais devagar.",
  specialTitle: "Medida e interpretação: o que cada variável informa e onde ela cala",
  special: [
...
const capSistemaReprodutor = deepLesson({
  ...
  figure: { id: "eixo-endocrino", title: "Eixo hipotálamo-hipófise-gônada", caption: "O eixo reprodutor segue o mesmo desenho de eixo endócrino: pulsos do hipotálamo e da hipófise comandam a gônada, e o hormônio final freia os dois por retroalimentação negativa." },
  ...
  apply: "Trate **energia, sono e recuperação** como determinantes da saúde reprodutiva, não detalhes. Ajuste **modalidade, impacto, posição e intensidade ao trimestre** na gestação, com orientação obstétrica.\n\n**Responder à abertura:** os achados conectam-se por **baixa disponibilidade energética**, que suprime o eixo gonadal e prejudica o osso; **peso estável não exclui o problema**, e a solução revisa ingestão, carga e recuperação, com encaminhamento.",
  specialTitle: "Medida e interpretação: o que cada variável informa e onde ela cala",
  special: [
...
const capSistemaTegumentar = deepLesson({
  ...
  figure: { id: "balanco-termico", caption: "O sangue leva ao tegumento o calor do núcleo, que se dissipa por radiação, convecção, condução e evaporação do suor; no calor e no exercício a evaporação domina, e a umidade alta a reduz." },
  ...
  apply: "Trate o ambiente térmico como **parte da dose**: reduza a carga inicial em calor, **aumente a exposição gradualmente** e monitore sinais. Guie a hidratação por **experiência, sede, taxa de suor e duração**.\n\n**Responder à abertura:** pele muito quente com piora de coordenação e confusão sugere **falha de dissipação de calor**; a prioridade é **interromper, resfriar e buscar atendimento**.",
  specialTitle: "Medida e interpretação: o que cada variável informa e onde ela cala",
  special: [
