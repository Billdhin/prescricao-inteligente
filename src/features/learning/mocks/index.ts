...
const autoradas = {
  modules: [...modulesBio, ...forcaModules, ...fisiologiaExercicioModules, ...cardioModules, ...avaliacaoModules],
  lessons: [...lessonsBio, ...forcaLessons, ...fisiologiaExercicioLessons, ...cardioLessons, ...avaliacaoLessons],
};
