...
const nodeTone: Record<string, string> = {
  ...
  analysis: "border-analysis/30 bg-analysis-tint text-analysis hover:border-analysis",
  success: "border-success/30 bg-success-tint text-success hover:border-success",
