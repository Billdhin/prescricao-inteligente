...
export const extraExercises2: Exercise[] = [
  /* ------------------------------ FLEXÃO DE BRAÇO ------------------------------ */
  {
    ...
    objetivo: ["Hipertrofia", "Resistência muscular", "Aprendizado técnico", "Emagrecimento", "Força"],
    nivel: "Iniciante",
  ...
  /* ------------------------------ SUPINO NA MÁQUINA ------------------------------ */
  {
    ...
    grupoMuscular: "Peitorais",
    equipamento: "Máquina",
    objetivo: ["Hipertrofia", "Retorno ao treino", "Aprendizado técnico", "Resistência muscular", "Emagrecimento"],
    nivel: "Iniciante",
    articulacaoPredominante: "Ombro e cotovelo",
    premium: false,
    resumoPratico:
    ...
    hotspots: [
      {
        ...
        camadas: {
          ...
          evidencia: "Boa opção nas primeiras semanas e no retorno pós-lesão, conduzida pela equipe de fisioterapia.",
  ...
  /* ------------------------------ DESENVOLVIMENTO NA MÁQUINA ------------------------------ */
  {
    ...
    grupoMuscular: "Ombros",
    equipamento: "Máquina",
    objetivo: ["Hipertrofia", "Força", "Retorno ao treino", "Emagrecimento"],
    nivel: "Iniciante",
    articulacaoPredominante: "Ombro e cotovelo",
    premium: false,
    resumoPratico:
  ...
  /* ------------------------------ DESENVOLVIMENTO COM ELÁSTICO ------------------------------ */
  {
    ...
    objetivo: ["Resistência muscular", "Retorno ao treino", "Aprendizado técnico", "Força", "Emagrecimento"],
    nivel: "Iniciante",
    articulacaoPredominante: "Ombro e cotovelo",
    premium: false,
    resumoPratico:
    ...
    hotspots: [
      {
        ...
        camadas: {
          ...
          evidencia: "Bandas são recurso comum na fisioterapia de ombro por serem articulações-amigáveis.",
    ...
    conteudo: {
      ...
      fisiologia:
        "De forma aguda, a carga leve no início do movimento permite treinar o padrão com conforto; de forma crônica, o volume constante tende a melhorar a resistência do ombro e a consolidar o controle escapular. É um recurso frequente na fisioterapia por poupar as articulações.",
      prescricaoPratica:
