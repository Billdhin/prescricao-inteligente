...
export const extraExercises: Exercise[] = [
  ...
  /* ------------------------------ SENTAR E LEVANTAR ------------------------ */
  {
    ...
    blocos: {
      quandoUsar: [
        ...
        "Retorno ao treino com dose finamente ajustável.",
  ...
  /* -------------------------------- PRANCHA FRONTAL ------------------------ */
  {
    ...
    equipamento: "Peso corporal",
    objetivo: ["Resistência muscular", "Aprendizado técnico", "Retorno ao treino", "Emagrecimento"],
    nivel: "Iniciante",
  ...
  /* ---------------------------------- DEAD BUG ----------------------------- */
  {
    ...
    grupoMuscular: "Core (tronco)",
    equipamento: "Peso corporal",
    objetivo: ["Retorno ao treino", "Aprendizado técnico", "Resistência muscular", "Emagrecimento"],
    nivel: "Iniciante",
  ...
  /* ------------------------------- REMADA ELÁSTICA ------------------------- */
  {
    ...
    objetivo: ["Resistência muscular", "Aprendizado técnico", "Retorno ao treino", "Força", "Emagrecimento"],
    nivel: "Iniciante",
