...
export const referencias: Referencia[] = [
  ...
  {
    id: "oranchuk-isometrico-2019",
    autores: "Oranchuk DJ, Storey AG, Nelson AR, Cronin JB",
    titulo: "Isometric training and long-term adaptations: Effects of muscle length, intensity, and intent: A systematic review",
    fonte: "Scandinavian Journal of Medicine & Science in Sports, 29(4):484-503",
    ano: 2019,
    doi: "10.1111/sms.13375",
    pmid: "30580468",
    nota: "É A REVISÃO QUE TIRA O ISOMÉTRICO DO LUGAR DE CONDUTA SÓ DE PRESSÃO ARTERIAL. Vinte e seis estudos de adaptações de médio a longo prazo (3 semanas ou mais) ao treino isométrico, em atletas, populações especiais e público geral. Três achados que viram parâmetro de prescrição: treinar em COMPRIMENTO MUSCULAR LONGO produz mais hipertrofia que o mesmo volume em comprimento curto (0,86 a 1,69% por semana contra 0,08 a 0,83%) e transfere mais para o desempenho dinâmico; INTENÇÃO BALÍSTICA rende mais ativação neuromuscular e mais produção rápida de força; e CONTRAÇÕES DE ALTA INTENSIDADE (70% ou mais) são NECESSÁRIAS para melhorar estrutura e função do TENDÃO. Ganho de hipertrofia e de força máxima apareceu em intensidades variadas, mas o tendão não. LIMITE DECLARADO: os próprios autores registram que poucos estudos preencheram os critérios de inclusão e que falta consenso sobre diretrizes de treino, então isto dá a DIREÇÃO dos parâmetros, não uma dose fechada.",
  },
  {
    id: "bogdanis-isometrico-angulo-2018",
    autores: "Bogdanis GC, Tsoukos A, Methenitis SK, Selima E, Veligekas P, Terzis G",
    titulo: "Effects of low volume isometric leg press complex training at two knee angles on force-angle relationship and rate of force development",
    fonte: "European Journal of Sport Science, 19(3):345-353",
    ano: 2018,
    doi: "10.1080/17461391.2018.1510989",
    pmid: "30114973",
    nota: "PROTOCOLO CONCRETO DO ISOMÉTRICO DE ALTA INTENSIDADE, com número. Quinze homens jovens, 3 vezes por semana, 6 semanas: 5 a 7 séries de 3 s de LEG PRESS ISOMÉTRICO MÁXIMO com 4 min de recuperação, em dois ângulos de joelho. No ângulo de músculo mais CURTO (145°) a força isométrica máxima subiu de 22 a 58% e a produção rápida de força de 18 a 43%, mas de forma ANGULO-ESPECÍFICA, perto do ângulo treinado; no ângulo de músculo mais LONGO (85°) o ganho foi moderado e uniforme em toda a amplitude (cerca de 12,3%). O salto vertical e o 1RM de meio agachamento subiram igual nos dois grupos (10,4% e 7,8%). DUAS COISAS QUE ESTE PRODUTO TIRA DAQUI: a dose é de contração CURTA e MÁXIMA, o oposto do protocolo de 2 min do agachamento na parede; e o ângulo treinado é uma variável da prescrição, não um detalhe. O estudo mediu força num leg press instrumentado, com 15 participantes.",
  },
  {
    id: "kubo-isometrico-tendao-2017",
    autores: "Kubo K, Ishigaki T, Ikebukuro T",
    titulo: "Effects of plyometric and isometric training on muscle and tendon stiffness in vivo",
    fonte: "Physiological Reports, 5(15):e13374",
    ano: 2017,
    doi: "10.14814/phy2.13374",
    pmid: "28801518",
    nota: "Onze participantes treinaram 12 semanas, 3 dias por semana, com PLIOMETRIA numa perna e ISOMÉTRICO na outra (desenho unilateral, cada um é o controle do outro). A rigidez do TENDÃO, medida por ultrassonografia em contração rampa e balística, aumentou no lado ISOMÉTRICO e NÃO no pliométrico; a rigidez ATIVA DO MÚSCULO aumentou no pliométrico e não no isométrico. Rigidez passiva e histerese não mudaram em nenhum dos dois. É a medida direta que sustenta a indicação do isométrico para TENDÃO, e ao mesmo tempo mostra que ele não substitui a pliometria: são adaptações diferentes, em tecidos diferentes. Amostra pequena, 11 participantes.",
  },
  {
    id: "blazevich-rfd-2020",
    autores: "Blazevich AJ, Wilson CJ, Alcaraz PE, Rubio-Arias JA",
    titulo:
    ...
    fonte: "Sports Medicine, 50(5):943-963",
    ano: 2020,
    doi: "10.1007/s40279-019-01239-x",
    pmid: "32034703",
    nota: "RESSALVA QUE MANDA NA REDAÇÃO DA SESSÃO, e não só um respaldo. Cinquenta e quatro estudos sobre produção rápida de força. Subiram a taxa de produção de força: velocidade alta (0,54), velocidade lenta COM A INTENÇÃO de produzir força rápida (0,41) e exercício com padrão de movimento ESPECÍFICO ao testado (0,38). NÃO subiram de forma clara: velocidade lenta SEM a intenção de acelerar (0,21, p=0,05) e exercício NÃO específico ao movimento (0,27, p=0,37). Ou seja, contração sustentada sem intenção de acelerar, num padrão que não é o do treino do aluno, é justamente a combinação que a meta-análise não sustenta. Por isso a sessão isométrica de desempenho deste produto prescreve contração MÁXIMA e CURTA com intenção de acelerar, e diz ao profissional que o ganho é maior quanto mais o ângulo escolhido se parecer com o do exercício principal. Os autores registram ainda que os ganhos se concentram nas primeiras semanas e que faltam dados em mulheres.",
  },
  {
    id: "saeterbakken-especificidade-2025",
    autores: "Saeterbakken AH, Stien N, Paulsen G, Behm DG, Andersen V, Solstad TEJ, Prieske O",
    titulo:
    ...
    fonte: "Sports Medicine, 55(7):1651-1676",
    ano: 2025,
    doi: "10.1007/s40279-025-02225-2",
    pmid: "40314751",
    nota: "CONTRAPESO REGISTRADO DE PROPÓSITO. Quarenta e três estudos e 1.660 participantes de 16 a 60 anos, treinados e destreinados: o treino resistido DINÂMICO melhora a força dinâmica com efeito moderado a grande (0,98) e transfere para a força ISOMÉTRICA não treinada com efeito apenas pequeno (0,42), pouco mais da metade. Os autores concluem que os dois desfechos representam DOMÍNIOS NEUROMUSCULARES DIFERENTES. Serve aqui para impedir a promessa fácil: acrescentar contração isométrica ao plano de um aluno de força não é o mesmo que somar força dinâmica, e o produto tem que dizer isso ao lado da sessão em vez de vender transferência. A direção medida é dinâmico para isométrico; o caminho inverso não foi o objeto deste estudo.",
  },
  {
    id: "yan-isometrico-pa-2026",
    autores: "Yan Y, Sun C, Pan L, Ma H, Xie H",
    titulo: "Effects of isometric training based on the entire population on blood pressure regulation: systematic review and meta-analysis of randomized controlled trials",
    fonte: "Frontiers in Public Health, 14:1774541",
    ano: 2026,
    doi: "10.3389/fpubh.2026.1774541",
    pmid: "41846839",
    nota: "Quarenta ensaios randomizados, população GERAL (não só hipertensos): o isométrico reduziu a sistólica em 6,72 mmHg (IC 95% -8,21 a -5,23) e a diastólica em 2,72 (IC 95% -3,57 a -1,87). Na análise por subgrupo, as maiores quedas apareceram com AGACHAMENTO NA PAREDE, 3 vezes por semana, por mais de 8 semanas, e foram MAIORES em homens e em hipertensos, o que é a razão de este produto separar a dose de tratamento da de prevenção. Heterogeneidade alta na sistólica (I²=74%) e a regressão não achou fator explicativo, o que os próprios autores registram. Tem ERRATA publicada (10.3389/fpubh.2026.1866759), que corrige o artigo sem mudar as conclusões.",
  },
  {
