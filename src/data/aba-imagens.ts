...
const VARIACAO_IMGS: Record<string, number[]> = {
  "rotacao-interna-elastico": [1],
  "rotacao-externa-elastico": [2],
  "scaption": [0, 1],
  "corrida-aquatica": [0, 2],
  "caminhada-plana": [0, 2],
  "escada-ergometrica": [2],
  "respiracao-360": [1, 2],
  "chin-tuck": [0, 1],
  ...
  "remada-cavalinho": [0, 1],
  "pullover-polia": [0, 1],
  "puxada-supinada": [0, 1],
  "flexao-apoio-elevado": [0, 1],
  "crossover-polia": [0, 2],
  "crucifixo-maquina": [2],
  "supino-inclinado-halteres": [0, 1],
  "leg-press-horizontal": [1, 2],
  "good-morning": [1, 2],
  "hip-thrust-unilateral": [2],
  "cadeira-abdutora": [0],
  "agachamento-goblet": [0, 1],
  "agachamento-bulgaro": [1, 2],
  "encolhimento-halteres": [0, 2],
  "face-pull-polia": [0, 1],
  "crucifixo-inverso": [0, 1],
  "elevacao-frontal": [1, 2],
  "triceps-testa-barra": [0, 2],
  "rosca-scott-maquina": [0],
  "rosca-banco-inclinado": [0, 2],
  "panturrilha-sentado": [1],
  "remada-unilateral-elastico": [0, 1],
  "extensao-quadril-elastico": [0, 1],
  "abducao-quadril-elastico": [0, 1],
  "rosca-elastico": [0, 1],
  "agachamento-elastico": [0],
  "clam-shell": [2],
  "elevacao-joelhos-suspenso": [0, 1, 2],
  "chop-elastico": [0, 1],
  "pallof-press-elastico": [0],
  "pallof-press-polia": [0, 2],
  "rosca-martelo": [0, 2],
  "prancha-apoio-banco": [2],
  "prancha-lateral": [0, 1],
