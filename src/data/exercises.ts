...
export const exercises: Exercise[] = [
  /* ------------------------------- LEG PRESS ------------------------------ */
  {
    ...
    equipamento: "Máquina",
    objetivo: ["Hipertrofia", "Força", "Aprendizado técnico", "Reabilitação/retorno"],
    nivel: "Iniciante",
  ...
  /* ---------------------------- AGACHAMENTO LIVRE ------------------------- */
  {
    ...
    grupoMuscular: "Membros inferiores",
    equipamento: "Barra",
    objetivo: ["Força", "Hipertrofia", "Aprendizado técnico"],
    nivel: "Avançado",
  ...
  /* -------------------------------- AFUNDO ------------------------------- */
  {
    ...
    grupoMuscular: "Membros inferiores",
    equipamento: "Halter",
    objetivo: ["Hipertrofia", "Força", "Aprendizado técnico"],
    nivel: "Intermediário",
  ...
  /* ------------------------------ PUXADA ALTA ---------------------------- */
  {
    ...
    equipamento: "Polia",
    objetivo: ["Hipertrofia", "Aprendizado técnico", "Resistência muscular"],
    nivel: "Iniciante",
    articulacaoPredominante: "Ombro e cotovelo",
    restricoes: [],
    premium: false,
