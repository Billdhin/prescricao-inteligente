...
export const extraExercises4: Exercise[] = [
  /* ============== LOTE B: ELÁSTICO E PESO CORPORAL (treino em casa) ============== */
  {
    ...
    objetivo: ["Emagrecimento", "Retorno ao treino", "Resistência muscular", "Força"],
    nivel: "Iniciante",
...

  {
    ...
    equipamento: "Elástico",
    objetivo: ["Hipertrofia", "Retorno ao treino", "Resistência muscular", "Força", "Emagrecimento"],
    nivel: "Iniciante",
...
imagem: "/exercises/rosca-elastico.webp",
...

  {
    ...
    grupoMuscular: "Membros inferiores",
    equipamento: "Elástico",
    objetivo: ["Retorno ao treino", "Resistência muscular", "Hipertrofia", "Emagrecimento"],
    nivel: "Iniciante",
    articulacaoPredominante: "Quadril",
    premium: false,
    resumoPratico:
...

  {
    ...
    grupoMuscular: "Costas",
    equipamento: "Elástico",
    objetivo: ["Hipertrofia", "Resistência muscular", "Retorno ao treino", "Força", "Emagrecimento"],
    nivel: "Iniciante",
    articulacaoPredominante: "Ombro e cotovelo",
    premium: false,
    resumoPratico:
