...
const PRIVACIDADE: Secao[] = [
  ...
  },
  {
    ...
    paragrafos: [
      ...
      "MEDIÇÃO ANÔNIMA DO VÍDEO DE APRESENTAÇÃO: quem assiste ao vídeo de apresentação do site gera um registro de medição sem identificação: um código aleatório criado pelo navegador (não é nome, e-mail nem endereço IP), o tipo de aparelho (celular, tablet ou computador), o nome do sistema e do navegador (sem versão), o fuso horário do aparelho, a origem da visita informada no próprio link (os parâmetros utm de origem, mídia, campanha, conteúdo e termo) ou apenas o domínio do site de onde a pessoa veio, e o que aconteceu com o vídeo (se o som foi ativado, de onde até onde foi assistido, quanto tempo, quantas pausas, se travou para carregar, quanto demorou para começar, se usou tela cheia ou o mini player e em que momento o botão foi clicado). Serve só para medir o desempenho do vídeo, com base no legítimo interesse, não é ligado a nenhuma conta, não é usado para publicidade e não é gerado quando o navegador pede para não ser rastreado. O próprio navegador guarda, só nele, o ponto em que o vídeo parou, para oferecer continuar de onde parou.",
