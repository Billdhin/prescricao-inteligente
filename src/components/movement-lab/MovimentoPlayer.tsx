  ...
  return (
    <figure className={cn("select-none", className)}>
      <div className="relative mx-auto aspect-[3/4] w-full max-w-[260px] overflow-hidden rounded-card border border-border bg-surface-soft shadow-soft">
        ...
        <span className="absolute left-2 top-2 inline-flex items-center gap-1 rounded-full border border-primary/20 bg-[#ffffff]/90 px-2 py-0.5 text-2xs font-semibold text-primary backdrop-blur-sm">
