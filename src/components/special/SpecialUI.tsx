    ...
    >
      ...
      >
        ...
        <div className="flex flex-wrap items-center justify-end gap-2 border-t border-border p-4">
          {p.ficha && (
            <button onClick={() => printFichaParametro(p, contexto, { nome: profNome, cref, logoDataUrl: logoDataUrl || undefined, corPrimaria: corPrimaria || undefined })} className={buttonClasses("primary", "sm")}>
